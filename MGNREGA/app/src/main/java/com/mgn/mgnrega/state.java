...
public class state extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1=(EditText)findViewById(R.id.statename);
        e2=(EditText)findViewById(R.id.statecode);
        e3=(EditText)findViewById(R.id.salarytext);
            ...
            public void onClick(View v) {
                ...
                if(s1.isEmpty() && s2.isEmpty() && s3.isEmpty())
                    Toast.makeText(getApplicationContext(),"Enter All fields",Toast.LENGTH_LONG).show();
                        ...
                        s4=new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date());
                        if(db.insert(s1,s2,s3,s4,s4)) {
                            Toast.makeText(getApplicationContext(), "State set successfully", Toast.LENGTH_LONG).show();
                            checkAndroidVersion();
                        }
                else
    ...
    private void checkAndroidVersion() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Toast.makeText(getApplicationContext(),"Go to settings and grant permission",Toast.LENGTH_LONG).show();
        }
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    protected void onResume() {
        ...
        if (!sharedpreferences.getBoolean(prevStarted, false)) {
            ...
            Intent i = new Intent(state.this, Main13Activity.class);
            startActivity(i);
        }
    }
